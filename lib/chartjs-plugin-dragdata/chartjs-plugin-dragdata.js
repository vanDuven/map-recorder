//source: https://github.com/chrispahm/chartjs-plugin-dragdata
(function (global, factory) {
  ...
  function calcPosition(e, chartInstance, datasetIndex, index, data) {
    ...
    //added min, max and offset
    x = x > chartInstance.config.options.plugins.dragData.maxX ? chartInstance.config.options.plugins.dragData.maxX : x;
    x = x < chartInstance.config.options.plugins.dragData.minX ? chartInstance.config.options.plugins.dragData.minX : x;
    
    y = y > chartInstance.config.options.plugins.dragData.maxY ? chartInstance.config.options.plugins.dragData.maxY : y;
    y = y < chartInstance.config.options.plugins.dragData.minY ? chartInstance.config.options.plugins.dragData.minY : y;
    

    x = x > chartInstance.scales[xAxisID].max + chartInstance.config.options.plugins.dragData.offsetmaxX ? 
      chartInstance.scales[xAxisID].max + chartInstance.config.options.plugins.dragData.offsetmaxX : x;
